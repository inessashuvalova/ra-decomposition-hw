...
import BottomLinksListWidget from './components/BottomWidget/BottomLinksListWidget';
import BottomTextWidget from './components/BottomWidget/BottomTextWidget';
import BottomWeatherWidget from './components/BottomWidget/BottomWeatherWidget';
    ...
    <div className="App">
      ...
      <div className="BlockWithWidgets">
        ...
        <BottomWidget
          ...
          content={<BottomLinksListWidget links={LINKSLIST1} />} />
        <BottomWidget
          headerLink={{ href: "#", title: "Widget with text" }}
          content={<BottomTextWidget text={BOTTOM_WIDGET_TEXT1} />} />
        <BottomWidget
          headerLink={{ href: "#", title: "Widget2 widh links" }}
          content={<BottomLinksListWidget links={LINKSLIST2} />} />
      </div>
    </div>
  );
}
